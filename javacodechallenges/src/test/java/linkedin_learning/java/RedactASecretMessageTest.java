...
public class RedactASecretMessageTest {
        ...
        public void redactTextFile_ensureRedaction() {
                ...
                try {
                    RedactASecretMessage.redactTextFile("sample.txt",
        ...
        public void redactTextFile_ensureSameRemainingContents() {
                ...
                try {
                    ...
                    RedactASecretMessage.redactTextFile("sample.txt",new String[] { "sally", "Kat","ready to go" });
                    ...
                    List<String> redactedLines = originalFileReader.lines().map(line -> line.replace("sally","REDACTED").replace("kat", "REDACTED").replace("Kat","REDACTED").replace("Sally","REDACTED").replace("ready to go","REDACTED")).collect(Collectors.toList());
        ...
        public void redactTextFile_wrongFileType() {
            ...
            RedactASecretMessage.redactTextFile("sample.jpg",
                                new String[] { "sally", "Kat", "ready to go" });
