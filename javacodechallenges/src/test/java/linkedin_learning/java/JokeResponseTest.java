...
public class JokeResponseTest {
    ...
    public void parseJoke() {
        Optional<String> jokeOpt = JokeResponse.parseJoke("{\"id\":\"abc\",\"status\":200,\"joke\":\"" + JOKE + "\"}");
    ...
    public void parseJoke_parseError() {
        ...
        Optional<String> jokeOpt = JokeResponse.parseJoke("today");
    ...
    public void parseJoke_noJokes() {
        ...
        Optional<String> jokeOpt = JokeResponse.parseJoke("[]");
        assertFalse(jokeOpt.isPresent());
    }
}
