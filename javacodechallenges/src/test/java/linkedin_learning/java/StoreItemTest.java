...
public class StoreItemTest {
    ...
    public void findLeastExpensive() {
        ...
        List<StoreItem> items = List.of(new StoreItem("T-Shirt", 19.99, .4),leastExpensive,new StoreItem("Record Player", 92.99, .75),new StoreItem("Hat", 23.99, .1),new StoreItem("Jeans", 54.99, .65));
        //assertEquals(Optional.of(leastExpensive), StoreItem.findLeastExpensive(items));
        //when(StoreItem.findLeastExpensive(items)).thenReturn(null);
    }
    ...
    public void findLeastExpensive_sameItemsDifferentDiscounts() {
        ...
        List<StoreItem> items = List.of(thirdLeastExpensive,secondLeastExpensive, leastExpensive);
